            ...
            <div className="contact-info-wrapper scroll-animate">
              <div className="contact-info-card">
                ...
                <p className="contact-info-sub">
                  Call or email our team for fast support and enquiries.
                </p>
                ...
                <div className="contact-social">
                  ...
                  <div className="contact-social-links">
                    <a href="https://www.facebook.com/share/1HNeQzaLr5/" target="_blank" className="contact-social-link" aria-label="Facebook">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                      </svg>
                    </a>
                    <a href="https://www.instagram.com/usagrishield?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" className="contact-social-link" aria-label="Instagram">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
